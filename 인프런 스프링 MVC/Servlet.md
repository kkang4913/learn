...
- ### 서블릿 컨테이너
  ...
  - ### 서블릿 컨테이너와 생명주기
    ...
    <br> 
    2. 최초의 요청시 동작 <br><br/>
     <img width="500" alt="image" src="https://user-images.githubusercontent.com/100770651/231062680-868aa69d-3241-4e93-a5bf-f76f1a32b64c.png"><br>
  ...
  - ```service()``` 메서드를 호출할 때, 새로운 스레드(스레드2)가 생성됨 <br>
